...
public class BillPutSale extends CommonEntity{
    ...
    private List<BillPutSaleList> billPutSaleList;


    public List<BillPutSaleList> getBillPutSaleList() {
        return billPutSaleList;
    }

    public void setBillPutSaleList(List<BillPutSaleList> billPutSaleList) {
        this.billPutSaleList = billPutSaleList;
    }
