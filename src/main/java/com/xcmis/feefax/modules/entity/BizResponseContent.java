 ...
 * @see
 */
public class BizResponseContent {
    private String code;
    private String msg;
    ...
    public BizResponseContent(){

    }

    public BizResponseContent(Collections c){
        code = "00000";
        msg = "success";
        trade_id = "";
        zone_code = "321111";
        //billno = "321111" + c.getSetYear().substring(2) + "100" + c.getBillNo() + "1";
    ...
    public BizResponseContent(String code, String msg){
        this.code = code;
        this.msg = code;
