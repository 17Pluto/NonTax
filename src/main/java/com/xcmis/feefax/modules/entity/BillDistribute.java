...
public class BillDistribute extends CommonEntity{
    ...
    private List<BillDistributeList> billDistributeList;

    public List<BillDistributeList> getBillDistributeList() {
        return billDistributeList;
    }

    public void setBillDistributeList(List<BillDistributeList> billDistributeList) {
        this.billDistributeList = billDistributeList;
    }
